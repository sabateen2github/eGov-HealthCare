 ...
 * @author Inspiron
 */
public class ProcedureContainer extends javax.swing.JPanel {

    /**
     * Creates new form ProcedureContainer
     */
    ...
    public void setData(GetCondtion.Condtion cond, boolean is_new) {
        ...
        if (!is_new) {
            ...
            for (int i = 0; i < cond.procedures.size(); i++) {
                addProcedure(cond.procedures.get(i));
            }
        }
    }
    ...
    public void addNewProcedure() {
        ...
        d.chooseProcedure(new Handler.ChoosedProc() {
            ...
            public void onChoose(GetProcedure.Procedure proc) {
                cond.procedures.add(0, proc);
                proc.type = Types.Type_Procedure_Condtion;
                ProcCondContainer p = new ProcCondContainer();
                p.setData(cond, proc, false);
                Container.add(p);
